        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center">
                <h5 className="section-sub-title" style={{fontSize:'25px'}}>
                  KPI Evaluation Metrics Framework for Vendors
                </h5>
                {/* <h1 className="section-main-title text-white">
                  How You Can Retain <span>Progressive Partnerships Path</span>?
                </h1> */}
              </div>
            </div>
            <div className="row">
                    ...
                    <div className="testi-box" key={index}>
                      <div className="testi-single-box ms-4 py-4">
                        ...
                        <div className="testi-content">
                          <p className="testi-text" style={{fontSize:"16px"}}>{slide.description}</p>
                          ...
                          <div className="row mt-3">
                            {slide.thresholds.map((threshold, thresholdIndex) => (
                              <div
            ...
            <div className="hero-video-icon d-flex justify-content-center">
                ...
                >
                  <i className="bi bi-pause"></i><span></span>
                </a>
              </div>
          </div>
        </div>
